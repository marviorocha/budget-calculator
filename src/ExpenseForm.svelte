...
>
  ...
  <div class="flex flex-col">
    ...
    <input
      ...
      bind:value={title}
      name="title"
      class="px-1 py-1 focus:outline-none border-b-2 border-0 mb-3 focus:ring-0  w-full"
    />
    ...
    <input
      ...
      name="amount"
      bind:value={amount}
      class="px-1 py-1 focus:outline-none border-b-2 border-0  focus:ring-0 w-full"
    />
    {#if emptyValue}
