...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 29, 4, 683);
    			attr_dev(div, "class", "flex justify-center");
    			add_location(div, file, 28, 2, 645);
    			attr_dev(main, "class", "container  mx-auto px-32 mt-5");
    			add_location(main, file, 24, 0, 536);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*clearExpensesAll*/ ctx[1], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [expenses, clearExpensesAll];
    }
