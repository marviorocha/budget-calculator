...
var app = (function () {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$4, 27, 6, 697);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i0, file$4, 23, 9, 590);
    			add_location(button0, file$4, 22, 6, 544);
    			attr_dev(h1, "class", "text-1xl font-bold capitalize");
    			add_location(h1, file$4, 20, 4, 482);
    			attr_dev(div0, "class", "expenses-info");
    			add_location(div0, file$4, 19, 2, 450);
    			attr_dev(i1, "class", "fas px-2 fa-edit text-green-600");
    			add_location(i1, file$4, 33, 7, 870);
    			add_location(button1, file$4, 32, 4, 817);
    			attr_dev(i2, "class", "fas fa-trash text-red-600");
    			add_location(i2, file$4, 36, 7, 977);
    			add_location(button2, file$4, 35, 4, 934);
    			attr_dev(div1, "class", "expenses-buttons");
    			add_location(div1, file$4, 31, 2, 782);
    			attr_dev(article, "class", "p-3 flex justify-between items-center bg-gray-100 rounded-md my-2 shadow-sm ");
    			add_location(article, file$4, 16, 0, 350);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 12, 4, 256);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div8, file$1, 4, 0, 70);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, setName, setAmount, isEditing*/ 65555) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 121, 4, 2604);
    			attr_dev(div, "class", "flex justify-center");
    			add_location(div, file, 120, 2, 2566);
    			attr_dev(main, "class", "container  mx-auto px-32 mt-5");
    			add_location(main, file, 101, 0, 2220);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		$$invalidate(2, expenses = localStorage.getItem("expenses")
